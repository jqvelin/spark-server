...
const StreamService_1 = require("../StreamService/StreamService");
const streamService = new StreamService_1.StreamService();
const router = (0, express_1.Router)();
exports.downloadRouter = router;
router.get('/:songId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { songId } = req.params, { artist, title } = req.query;
